...
def process_single_mesh(mesh_info: tuple[str, str, Path]) -> Optional[tuple[str, list[tuple[str, str]]]]:
    ...
    Returns:
        (mesh_name, [(part_name, part_file)]) holding the single hull part, or
        None if the mesh could not be processed.
    """
    ...
    # Hulls live beside the source mesh, mirroring the parts layout
